...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    YMDrawViewController *vc1 = [[YMDrawViewController alloc] init];
    vc1.title = @"单点触摸";
    YMMultipleDrawViewController *vc2 = [[YMMultipleDrawViewController alloc] init];
    vc2.title = @"多点触摸";
    
    UITabBarController *bvc = [[UITabBarController alloc] init];
    bvc.viewControllers = @[vc1,vc2];
